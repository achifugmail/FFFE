        ...
        try {
            ...
            playerStats.forEach(player => {
                ...
                playerRow.innerHTML = `
                    ...
                    <td class="adjustment-column"><input type="number" class="adjustment-input" value="${player.Adjustment || 0}" data-player-id="${player.userTeamPlayerId}" data-original-value="${player.Adjustment || 0}"></td>
                    <td class="adjustment-comment-column"><input type="text" class="adjustment-comment-input" value="${player.AdjustmentComment || ''}" data-player-id="${player.userTeamPlayerId}" data-original-value="${player.AdjustmentComment || ''}" placeholder="Enter comment"></td>
